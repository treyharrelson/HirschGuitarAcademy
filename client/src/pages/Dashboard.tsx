        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-gray-50 min-h-screen">
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="w-full lg:w-72 flex-shrink-0">
                    ...
                    {/* Navigation Links */}
                    <nav className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden sticky top-8">
                ...
                <div className="flex-1">
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
                        ...
                        {feedLoading
                            ...
                            : (feedPosts || []).length === 0
                                ? (
                                    <div className="text-center py-16 px-4 bg-gray-50 rounded-xl border border-gray-100 border-dashed">
                                        <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-gray-100 mb-4 text-gray-400">
                                            {Icons.Forum}
                                        </div>
                                        <h3 className="text-lg font-medium text-gray-900 mb-1">Your feed is quiet</h3>
                                        <p className="text-gray-500 max-w-sm mx-auto">
                                            Subscribe to some threads in the forum to see them appear here automatically.
                                        </p>
                                    </div>
                                )
                                : (
